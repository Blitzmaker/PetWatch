...
class _NewsScreenState extends ConsumerState<NewsScreen> {
  ...
  String _buildErrorMessage(DioException e) {
    ...
    if (_isForbiddenOrNotFound(e)) {
      return 'Kein Zugriff auf die News-Collection. Prüfe in Directus die Leserechte für "${_candidateCollections().join(' / ')}" '
        ...
        child: _error != null
            ...
            : _posts.isEmpty
                ? ListView(
                    children: const [
                      SizedBox(height: 120),
                      Center(child: Text('Noch keine News-Beiträge vorhanden.')),
                    ],
                  )
                : ListView.separated(
